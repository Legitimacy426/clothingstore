...
const Categories = () => {
  ...
  <div className='grid  md:grid-cols-3 grid-cols-1 border-2 '>
...
<div className="card relative border-1-2 ">
  <img src="/images/img8.jpeg" alt="Shoes"  />
  <h2 className='absolute bottom-4 left-2 text-slate-200 text-xl font-bold drop-shadow-lg outline-black'>MEN-BAGS</h2>
 
</div>
<div className="card relative border-1-2 ">
  <img src="/images/img7.jpeg" alt="Shoes"  />
  <h2 className='absolute bottom-4 left-2 text-slate-200 text-xl font-bold drop-shadow-lg outline-black'>MEN-BAGS</h2>
 
</div>
<div className="card relative border-1-2 ">
  <img src="/images/img6.jpeg" alt="Shoes"  />
  <h2 className='absolute bottom-4 left-2 text-slate-200 text-xl font-bold drop-shadow-lg outline-black'>MEN-BAGS</h2>
 
</div>
<div className="card relative border-1-2 ">
  <img src="/images/img3.jpeg" alt="Shoes"  />
  <h2 className='absolute bottom-4 left-2 text-slate-200 text-xl font-bold drop-shadow-lg outline-black'>MEN-BAGS</h2>
